...
<script>
// @ is an alias to /src
import HeaderSoe from "@/components/HeaderSoe.vue";
import FooterSoe from "@/components/FooterSoe.vue";
import RelatedProductSoe from "@/components/RelatedProductSoe.vue";
